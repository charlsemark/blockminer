          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-white text-center flex flex-col max-w-3xl gap-4 items-center"> 
              ...
              <div className='flex flex-row items-center gap-2 md:gap-4'>
                <Link className='py-3 px-6 text-lg font-bold bg-[#BB9533] rounded-lg' href={slide.link1}>{slide.text1}</Link>
                <Link className='py-3 px-6 text-lg font-bold bg-[#BB9533] rounded-lg' href={slide.link2}>{slide.text2}</Link>
              </div>
            </div>
          </div>
        </div>
