    ...
    >
      <div className="container flex md:flex-row items-center justify-between flex-col">
        ...
        <div
          ...
          data-aos-delay="400"
        >
          <h1 className="text-xl md:text-3xl lg:text-3xl font-bold mb-5 lg:mb-6 -tracking-wide md:w-3/4 lg:3/5 text-[#BB9533]">
          ...
          <button className="flex items-center space-x-1 bg-[#BB9533] text-white text-[16px] px-5 py-3 hover:opacity-80 ease-in duration-200 rounded-md">
