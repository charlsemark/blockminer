        ...
        <>
            ...
            <div className="w-full mt-2 mx-auto mb-10 relative">
                <div className="w-full flex items-center flex-col justify-center mt-10 mx-0 mb-0 space-y-6">
                    <div className="">
                        <h3 className="text-[#BB9533] font-medium text-lg">OUR PLANS</h3>
                    </div>
                        ...
                        {loading ? (
                            ...
                            allPlans?.map(plan => (
                                <div key={plan.id} className="w-[320px] rounded-xl border-[0.6px] border-gray-300 h-auto flex flex-col items-center relative">
                                    ...
                                    <button className="my-3 inline-block bg-[#BB9533] py-3 px-5 text-base font-medium tracking-wide text-white rounded-md" onClick={() => handleInvestNow(plan)}>Invest Now</button>
                                </div>
                            ))
                        )}
                    </div>
