            ...
            <div className="bg-white text-[#333] flex flex-col space-y-6 w-[320px] md:w-[520px] p-4 mt-20 mx-0 mb-0 rounded-lg">
                <div className="border-b-[1px] border-gray-600">
                    <div className="flex items-center px-4 py-6 justify-between">
                        ...
                        <button className="bg-[#BB9533] px-3 py-3 text-white text-sm tracking-wide rounded-md" onClick={onClose}>Close</button>
                    </div>
                </div>
                ...
                <button onClick={handleInvestment} className="mt-1.5 inline-block bg-[#BB9533] py-4 rounded-lg px-5 font-medium tracking-wide text-white">Start Investment</button>
            </div>
            <Notifications />
        </div>
    )
