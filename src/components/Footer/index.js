        ...
        <footer className="w-full bg-[#fff] border-t-[0.5px] border-gray-200 sm:mx-auto">
            <div className="mx-auto w-full px-10 py-18 lg:py-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li>
                                    <a href="mailto:support@Blockchainminers.online" className="hover:underline text-gray-500"> support@Blockchainminers.online</a>
                                </li>
                                <li>
                ...
                <div className="text-gray-900">
                    <p className="text-sm">
                        Blockchainminers is one of the leading platforms in the United States offering binary options, Forex and spreads. Regulated by the CFTC and based in Manchester. It is also regulated by the IFSC of Belize, as well as the Cyprus Securities and Exchange Commission
                    </p>
                </div>
                <hr className="my-6 border-gray-200 sm:mx-auto lg:my-8" />
                <div className="sm:flex sm:items-center sm:justify-between text-gray-900
                ">
                    <span className="text-sm text-gray-500 sm:text-center">© 2023 <a href="/" className="hover:underline">Blockchainminers™</a>. All Rights Reserved.
                    </span>
                </div>
            </div>
        </footer>
