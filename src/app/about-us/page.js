            ...
            <div className="pt-16 text-white">
                <div>
                    <div className='relative h-[50vh] md:h-[80vh] overflow-hidden'>
                        <div className='absolute top-0 left-0 w-full h-full'>
                            ...
                            <div className="absolute inset-0 bg-[#BB9533] opacity-20"></div>
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-white text-center flex flex-col max-w-3xl gap-4 items-center">
                                    <h3 className="text-4xl font-bold">About Blockchainminers</h3>
                    ...
                    <div className="container md:px-40 flex flex-col items-center gap-6">
                        ...
                        <div className="flex flex-col text-center items-center gap-2 px-4">
                            <h3 className="text-xl md:text-3xl font-bold max-w-2xl">
                                WHY CHOOSE Blockchainminers?
                            </h3>
                            <p className='text-center text-sm'>
                                Blockchainminers is a leading investment/ asset management company offering premium investment services to investors; both individuals and corporations. We pride ourselves in our guarantees and success track record in the trading/investment market.<br />
                ...
                <div className="mx-auto bg-[#fff]  py-20 w-full">
                    <div className='flex flex-col gap-4 items-start px-6'>
                        ...
                        <p className='text-sm text-[#777] font-light'>We&apos;re proud to be an asset management company whose culture is driven by strong values and a long-term vision. At Blockchainminers, our vision, mission and core values serve as the catalyst in our relations with our clients, employees, shareholders and in the communities in which we live and work. They are our guiding compass in our business each day.</p>
                        <p className='text-sm text-[#777] font-light'>Blockchainminers is dedicated to helping investors around the world reach their desired investment goals and broaden their financial horizons.</p>
                        ...
                        <p className='text-sm text-[#777] font-light'>Blockchainminers was founded on a simple but revolutionary idea that an investment company should be run for the sole benefit of its investors. And so Blockchainminers was designed to be different, removing outside owners and outside interests from the equation. Because of our investor-owned structure, Blockchainminers&apos;s success can only be measured by your success.
                            Low costs, a long-term orientation, and focus on your goals are at the core of Blockchainminers&apos;s investing philosophy, and not just because they sound good. They&apos;re essential to our approach because they&apos;re essential to the thing that really matters to you: the opportunity for investment success. So however you shape your portfolio, you can be sure that these principles run through everything we do</p>
                        <p className='text-sm text-[#777] font-light'>Blockchainminers&apos;s mission is to help investors reach their goals, and that means access to advice that works for you. Whether through our own advisory services or supporting financial advisors, we stand firm in our belief that all investors deserve advice that can be trusted and puts your interests first. That&apos;s why we seek to provide the advice offerings you need to build your financial future.</p>
                        <p className='text-sm text-[#777] font-light'>Strategy matters. Blockchainminers&apos;s approach to managing investments on behalf of our clients is to combine an in-depth appreciation of their unique circumstances and objectives with the investment capacity of a large-scale institutional investor. That means knowing when to apply traditional strategies and when to deviate to ensure consistent, strong risk-adjusted returns.</p>
                    </div>
                </div>
            </div>
            <Footer />
