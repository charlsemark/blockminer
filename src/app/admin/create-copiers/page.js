                ...
                <div className="flex flex-col w-full mt-5 mx-0 mb-0 border-[0.5px] rounded-sm border-gray-600">
                    <div className="border-b-[1px] border-gray-600">
                        <div className="flex items-center px-4 py-6 justify-between">
                            ...
                            <a href="/dashboard/trades" className="bg-[#BB9533] px-3 py-3 text-white text-sm tracking-wide rounded-md">View Copiers</a>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-4 px-4 pt-8 pb-4">
                        ...
                        <button className="disabled:opacity-50 flex items-center justify-center bg-[#BB9533] px-6 py-4 text-lg tracking-wide text-white transition-all ease-in-out duration-200 font-medium focus:shadow rounded-md" onClick={handleFormSubmit}>{componentLevelLoader && componentLevelLoader.loading ? <ComponentLevelLoader
                            text={"Loading"}
                            color={"#fff"}
