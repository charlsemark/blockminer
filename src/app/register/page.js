          ...
          <div className="flex flex-col justify-center items-center w-full lg:flex-row">
            <div className="w-full mt-4 mb-10 mr-0 ml-0 relative max-w-3xl lg:mt-24 lg:w-5/12">
              <div className="flex flex-col items-center justify-start px-3 py-10 bg-white shadow-xl rounded-xl relative z-10">
                <p className="text-[#BB9533] w-full text-2xl font-semibold text-center">
                  {isRegistered ? (
                ...
                {isRegistered ? (
                  <button
                    ...
                    className="disabled:opacity-50 inline-flex w-fit items-center justify-center bg-[#BB9533] px-5 py-2 text-base tracking-wide text-white transition-all ease-in-out duration-200 font-medium focus:shadow rounded-md mt-4"
                  >
                    Goto Login Now
                  </button>
                ) : (
                  <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-6">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <button
                        className="disabled:opacity-50 inline-flex items-center justify-center bg-[#BB9533] px-5 py-2 text-base tracking-wide text-white transition-all ease-in-out duration-200 font-medium focus:shadow rounded-md mt-4 w-full"
                      ...
                      <p className="text-sm text-black text-center mt-3">
                        ...
                        <a
                          href="/login"
                          className="text-[#BB9533] font-semibold underline cursor-pointer"
                        >
                          Login
                        </a>
                      </p>
