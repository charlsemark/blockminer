      ...
      <div className="bg-white">
        ...
        <div className="w-full px-10 flex flex-col items-start md:items-center md:justify-start gap-3 justify-end my-8 md:my-40">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 w-[380px]">
            ...
            <button type="submit" className="disabled:opacity-50 flex items-center justify-center bg-[#BB9533] px-6 py-2 text-lg tracking-wide text-white transition-all ease-in-out duration-200 font-medium focus:shadow rounded-md w-full">Submit</button>
          </form>
        </div>
        <Footer />
      </div>
